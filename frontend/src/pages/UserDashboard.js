...
  
  // ✅ DEFINED: Placeholder/Fallback Image URL
  const PLACEHOLDER_IMAGE = "https://placehold.co/400x250/505050/ffffff?text=Restaurant";
...
                <button onClick={() => navigate("/user/profile")}>Edit Profile</button>
                {/* ✅ ADDED: Link to Restaurant Dashboard for owners */}
...
                <img
                  // ✅ FIX: Use r.image directly (it's the permanent Cloudinary URL)
                  src={r.image || PLACEHOLDER_IMAGE}
                  alt={r.name}
