// src/pages/RestaurantDashboard.js (Fully Corrected and Modified - Complete Code)
...
const RestaurantDashboard = () => {
  ...
  const addMenuItem = async () => {
    ...
    try {
      // Fixed: Use JSON headers and stringify body
  ...
  const confirmDelete = async () => {
    ...
    try {
      await authFetch(`/restaurants/me/menu/${itemToDelete._id}`, { 
        method: "DELETE" 
      });
        ...
        {showDeleteConfirm && (
          <div className="delete-modal-overlay" onClick={cancelDelete}>
            <div className="delete-modal" onClick={e => e.stopPropagation()}>
              ...
              <p>Are you sure you want to delete <span className="item-name">{itemToDelete?.name}</span>?</p>
